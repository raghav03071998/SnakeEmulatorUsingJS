...
var direction = 'right';
var element = document.querySelector("#" + "snake");
...
setInterval(function () {
  ...
  if (snakeCollideWithobstacle || !snakeCollideWithBox) {
    alert('Game over'); // setObstaclePosition();
...
function moveSnakeRight() {
  var newPos = parseInt(style.marginLeft) + speed + "px";
...
function moveSnakeDown() {
  var newPos = parseInt(style.marginTop) + speed + "px";
...
function handleSnakeFoodCollision() {
  score = score + 1;
  speed = speed + 2;
  var newWidthOfSnake = parseInt(style.width) + 5 + "px";
